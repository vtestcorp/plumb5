...
public class TC_14_Web_FormsBanners_FormPreview extends BaseClass {
	...
	public void Create_Group() throws Exception {
		...
		test = extent.createTest("TC_14_Web_FormsBanners_FormPreview", "Web_FormsBanners_FormPreview");
		...
		managePopUpForms.verify_SuccessMessage(JsonUtils.getData(DefineConstants.TC_14_Web_FormsBanners_FormPreview, "Success Message"));
		managePopUpForms.searchForm();
		managePopUpForms.verifyInputValue();
		managePopUpForms.select_FormToEdit();
		managePopUpForms.click_PreviewButton();	
	}
}