...
public class TC_27_Settings_Configuration_Add_ESP_Delete_ESP extends BaseClass {
	...
	public void Create_Group() throws Exception {
		...
		test = extent.createTest("TC_27_Settings_Configuration_Add_ESP_Delete_ESP",
				"Settings_Configuration_Add_ESP_Delete_ESP");
		...
		settings.enter_ProviderName(
				JsonUtils.getData(DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP, "Provider Name"));
		// Promotional Setting
		settings.click_PromotionalSettings();

		settings.enter_AccountName(JsonUtils.getData(DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP,
				"Promotional Account Name"));
		settings.enter_APIKey(JsonUtils.getData(DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP,
				"Promotional API Key"));
		settings.enter_ConfigurationUrl(JsonUtils.getData(
				DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP, "Promotional Configuration Url"));
		settings.click_TransactionalSettings();
		// Transactional Settings

		settings.enter_AccountNameTransactional(JsonUtils.getData(
				DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP, "Transactional Account Name"));
		settings.enter_APIKeyTransactional(JsonUtils
				.getData(DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP, "Transactional API Key"));
		settings.enter_ConfigurationUrlTransactional(JsonUtils.getData(
				DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP, "Transactional Configuration Url"));
		settings.click_SubmitButton();
		settings.verify_SuccessMessage(JsonUtils.getData(
				DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP, "Service Provider Success Message"));
		...
		settings.verifyDeletedSuccessfully(JsonUtils.getData(DefineConstants.TC_27_Settings_Configuration_Add_ESP_Delete_ESP, "Email Service Provider Delete Success Message"));
