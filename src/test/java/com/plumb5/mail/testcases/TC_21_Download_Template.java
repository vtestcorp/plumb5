...
public class TC_21_Download_Template extends BaseClass {
	...
	public void Create_Group() throws Exception {
		...
		test = extent.createTest("TC_21_Download_Template", "Download_Template");
		...
		template.search_Template(JsonUtils.getData(DefineConstants.TC_21_Download_Template, "Template Name"));
        template.verifyInputValue(JsonUtils.getData(DefineConstants.TC_21_Download_Template, "Template Name"));
        template.selectTemplateToEdit(JsonUtils.getData(DefineConstants.TC_21_Download_Template, "Template Name"));                
        template.click_DownloadButton();
