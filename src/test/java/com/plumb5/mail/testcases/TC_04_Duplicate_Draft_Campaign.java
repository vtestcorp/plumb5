...
public class TC_04_Duplicate_Draft_Campaign extends BaseClass {
	...
	public void Create_Group() throws Exception {
		...
		test = extent.createTest("TC_04_Duplicate_Draft_Campaign", "Duplicate_Draft");
		...
		campaigns.search_Draft(JsonUtils.getData(DefineConstants.TC_04_Duplicate_Draft_Campaign, "Campaign Name"));
		campaigns.verifyInputValue(JsonUtils.getData(DefineConstants.TC_04_Duplicate_Draft_Campaign, "Campaign Name"));
		campaigns.select_DraftToEdit(JsonUtils.getData(DefineConstants.TC_04_Duplicate_Draft_Campaign, "Campaign Name"));
		campaigns.click_Duplicate();
		campaigns.verify_SuccessMessage(JsonUtils.getData(DefineConstants.TC_04_Duplicate_Draft_Campaign, "Success Message"));
	}
}
