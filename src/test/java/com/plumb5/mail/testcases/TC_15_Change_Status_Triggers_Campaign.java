...
public class TC_15_Change_Status_Triggers_Campaign extends BaseClass {
	...
	public void Create_Group() throws Exception {
		...
		test = extent.createTest("TC_15_Change_Status_Triggers_Campaign", "Change_Status_Triggers_Campaign");
		...
		triggers.search_Draft(JsonUtils.getData(DefineConstants.TC_15_Change_Status_Triggers_Campaign, "Trigger Identifier"));
		triggers.verifyInputValue(
				JsonUtils.getData(DefineConstants.TC_15_Change_Status_Triggers_Campaign, "Trigger Identifier"));
		triggers.check_TriggerStatus();
		// Change trigger Status
		triggers.selectTriggerToEdit(JsonUtils.getData(DefineConstants.TC_15_Change_Status_Triggers_Campaign, "Trigger Identifier"));
		triggers.select_ChangeStatus();
		triggers.verify_SuccessMessage(JsonUtils.getData(DefineConstants.TC_15_Change_Status_Triggers_Campaign, "Success Message"));
		triggers.check_TriggerStatus();	
	}
}