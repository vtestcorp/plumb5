...
public class TC_12_Search_Triggers_Campaign extends BaseClass {
	...
	public void Create_Group() throws Exception {
		...
		test = extent.createTest("TC_12_Search_Triggers_Campaign", "Search_Triggers_Campaign");
		...
		triggers.search_Draft(JsonUtils.getData(DefineConstants.TC_12_Search_Triggers_Campaign, "Trigger Identifier"));
		triggers.verifyInputValue(
				JsonUtils.getData(DefineConstants.TC_12_Search_Triggers_Campaign, "Trigger Identifier"));
	}
}