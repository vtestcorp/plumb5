...
public class TC_05_Delete_Draft_Campaign extends BaseClass {
	...
	public void Create_Group() throws Exception {
		...
		test = extent.createTest("TC_05_Delete_Draft_Campaign", "Delete_Draft");
		...
		campaigns.search_Draft(JsonUtils.getData(DefineConstants.TC_05_Delete_Draft_Campaign, "Campaign Name"));
		campaigns.verifyInputValue(JsonUtils.getData(DefineConstants.TC_05_Delete_Draft_Campaign, "Campaign Name"));
		campaigns.select_DraftToEdit(JsonUtils.getData(DefineConstants.TC_05_Delete_Draft_Campaign, "Campaign Name"));
		campaigns.click_Delete();
		campaigns.click_Delete_PopUp();
		campaigns.verify_SuccessMessage(JsonUtils.getData(DefineConstants.TC_05_Delete_Draft_Campaign, "Success Message"));
	}
}
