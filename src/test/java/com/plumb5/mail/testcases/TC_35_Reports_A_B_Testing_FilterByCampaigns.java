...
public class TC_35_Reports_A_B_Testing_FilterByCampaigns extends BaseClass {
	...
	public void Create_Group() throws Exception {
		...
		test = extent.createTest("TC_35_Reports_A_B_Testing_FilterByCampaigns",
				"Reports_A_B_Testing_FilterByCampaigns");
		...
		reports.click_A_B_Testing();
		reports.select_ShowingDataFor(
				JsonUtils.getData(DefineConstants.TC_35_Reports_A_B_Testing_FilterByCampaigns, "Showing Data For"),
				JsonUtils.getData(DefineConstants.TC_35_Reports_A_B_Testing_FilterByCampaigns, "Start Date"),
				JsonUtils.getData(DefineConstants.TC_35_Reports_A_B_Testing_FilterByCampaigns, "End Date"));
		reports.click_FilterByCampaigns();
		reports.search_FilterByCampaigns(
				JsonUtils.getData(DefineConstants.TC_35_Reports_A_B_Testing_FilterByCampaigns, "Campaigns Name"));
