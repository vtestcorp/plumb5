...
public class SMS_Reports {
	...
	public SMS_Reports(WebDriver driver, ExtentTest test) {
		this.driver = driver;
	...
	@FindBy(xpath = "//select[@id='ui_ddCampaignnames']")
	private WebElement filterByCampaigns;

	@FindBy(className = "//select[@id='ui_ddCampaignnames']")
	...
	@FindBy(xpath = "//button[@id='selectdateDropdown']//following::i[5]")
	private WebElement smsReports_DowloadButton;
	...
	@FindBy(xpath = "//select[@id='ui_ddl_ExportFileType']")
	private WebElement fileFormat_SMSReports;
	...
	@FindBy(xpath = "//select[@id='ui_ddl_ExportDataRange']")
	...
	public void select_FilterByCampaigns(String input_FilterByCampaigns) {
		try {
			Thread.sleep(3000L);
			applyWait.waitForElementToBeClickable(filterByCampaigns, DefineConstants.explicitWait_30);
			dropDown.selectByValue(filterByCampaigns, input_FilterByCampaigns);
			Screenshots.takeScreenshot(driver, "User selected " + input_FilterByCampaigns + " as campaign name");
			test.log(Status.INFO, "User selected " + input_FilterByCampaigns + " as campaign name");
			Log.info("User selected " + input_FilterByCampaigns + " as campaign name");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void click_DownloadButton_SMSReports() {
		try {
			applyWait.waitForElementToBeClickable(smsReports_DowloadButton, DefineConstants.explicitWait_30).click();
			Screenshots.takeScreenshot(driver, "User clicked download button on SMS Reports");
			test.log(Status.INFO, "User clicked download button on SMS Reports");
			Log.info("User clicked download button on SMS Reports");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void search_FilterByCampaigns(String input_FilterByCampaigns) {
		try {
			...
			dropDown.selectByValue(search_FilterByCampaigns, input_FilterByCampaigns);
	...
	public void search_FilterByReason(String input_FilterByReason) {
		try {
			...
			// javascriptClick.sendKeys(search_FilterByReasonBouncedContacts,
			// input_FilterByReason);
	...
	public void select_ShowingDataFor(String input_ShowingDataFor, String input_StartDate, String input_EndDate) {
		try {
			applyWait.waitForElementToBeClickable(showingDataFor, DefineConstants.explicitWait_30);
			javascriptClick.click(showingDataFor);
	...
	public void select_FileFormat_SMSReports(String input_FileFormat) {
		try {
			applyWait.waitForElementToBeClickable(fileFormat_SMSReports, DefineConstants.explicitWait_30);
			// javascriptClick.click(fileFormat);
			dropDown.selectByVisibleText(fileFormat_SMSReports, input_FileFormat);
			Screenshots.takeScreenshot(driver, "User selected " + input_FileFormat + " as format Type");
			test.log(Status.INFO, "User selected " + input_FileFormat + " as format Type");
			Log.info("User selected " + input_FileFormat + " as format Type");
		} catch (Exception e) {
	...
	public void select_ExportDataBy_SMSReports(String input_ExportDataBy, String from_Range, String to_Range) {
		try {
			...
			Screenshots.takeScreenshot(driver, "User selected " + input_ExportDataBy + " as export data by");
			test.log(Status.INFO, "User selected " + input_ExportDataBy + " as export data by");
			Log.info("User selected " + input_ExportDataBy + " as export data by");
			if (input_ExportDataBy.equals("Input")) {
				applyWait.waitForElementToBeClickable(inputFrom, DefineConstants.explicitWait_30).sendKeys(from_Range);
				applyWait.waitForElementToBeClickable(inputTo, DefineConstants.explicitWait_30).sendKeys(to_Range);
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void click_FileFormat_DownloadButton() {
		try {
			applyWait.waitForElementToBeClickable(fileFormatDownloadButton, DefineConstants.explicitWait_30);
			javascriptClick.click(fileFormatDownloadButton);
