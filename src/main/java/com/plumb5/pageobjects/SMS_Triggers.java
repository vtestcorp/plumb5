...
public class SMS_Triggers {
	...
	public SMS_Triggers(WebDriver driver, ExtentTest test) {
		this.driver = driver;
	...
	@FindBy(xpath = "//input[@id='ui_testToPhoneNumber']")
	...
	@FindBy(xpath = "//span[@id='select2-selectsmstemp-container']")
	...
	@FindBy(xpath = "//button[@id='btnIndividualOrGroupTestCampaign']")
	private WebElement testCampaignButton;
	...
	@FindBy(xpath = "//span[@id='select2-selectsmstemp-container']//following::input[148]")
	private WebElement selectTemplate_Search;

	@FindBy(xpath = "//span[@id='select2-selectrule-container']")
	private WebElement selectRule;

	@FindBy(xpath = "//span[@id='select2-selectrule-container']//following::input[146]")
	private WebElement selectRuleSearch;
	...
	public void select_TestCampaign_Value1(String input_TestCampaign) {
		deliveryTime = driver.findElement(By.xpath("//label[text()='" + input_TestCampaign + "']"));
		applyWait.waitForElementToBeClickable(deliveryTime, DefineConstants.explicitWait_30).click();
		try {
			Screenshots.takeScreenshot(driver, input_TestCampaign + " is selected as Test Campaign");
			test.log(Status.INFO, input_TestCampaign + " is selected as Test Campaign");
			Log.info(input_TestCampaign + " is selected as Test Campaign");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	public void select_TestCampaign_Value2(String input_TestCampaign) {
		deliveryTime = driver.findElement(By.xpath("//label[text()='" + input_TestCampaign + "']"));
		applyWait.waitForElementToBeClickable(deliveryTime, DefineConstants.explicitWait_30).click();
		try {
			Screenshots.takeScreenshot(driver, input_TestCampaign + " is selected as Test Campaign");
	...
	public void click_TestCampaign_Button() {
		try {
			applyWait.waitForElementToBeClickable(testCampaignButton, DefineConstants.explicitWait_30).click();
			Screenshots.takeScreenshot(driver, "User clicked Test Campaign Button");
			test.log(Status.INFO, "User clicked Test Campaign Button");
			Log.info("User clicked Test Campaign Button");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void enter_PhoneNumber(String input_PhoneNumber) {
		try {
			applyWait.waitForElementToBeClickable(phoneNumber, DefineConstants.explicitWait_30)
					.sendKeys(input_PhoneNumber);
			Screenshots.takeScreenshot(driver, input_PhoneNumber + " is entered as phone number");
			test.log(Status.INFO, input_PhoneNumber + " is entered as phone number");
			Log.info(input_PhoneNumber + " is entered as phone number");
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public void select_Template(String input_Template) {
		try {
			applyWait.waitForElementToBeClickable(selectTemplate, DefineConstants.explicitWait_30).click();
			// javascriptClick.click(selectTemplate);
			applyWait.waitForElementToBeClickable(selectTemplate_Search, DefineConstants.explicitWait_30).click();
			selectTemplate_Search.sendKeys(input_Template);
			selectTemplate_Search.sendKeys(Keys.ENTER);
	...
	public void search_Triggers(String input_SearchTriggers) {
		try {
			applyWait.waitForElementToBeClickable(search_Triggers, DefineConstants.explicitWait_10)
					.sendKeys(input_SearchTriggers);
			search_Triggers.sendKeys(Keys.ENTER);
			Screenshots.takeScreenshot(driver, "User searched Trigger Name " + input_SearchTriggers);
			test.log(Status.INFO, "User searched Trigger Name " + input_SearchTriggers);
			Log.info("User searched Trigger Name " + input_SearchTriggers);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void selectTestOption() {
		try {
			Thread.sleep(3000L);
			applyWait.waitForElementToBeClickable(testButton, DefineConstants.explicitWait_30).click();
			Screenshots.takeScreenshot(driver, "User clicked test button");
		} catch (Exception e) {
			e.printStackTrace();
		}
		test.log(Status.INFO, "User clicked test button");
		Log.info("User clicked test button");
	}
	...
	public void select_Rule(String input_SelectRule) {
		try {
			applyWait.waitForElementToBeClickable(selectRule, DefineConstants.explicitWait_30).click();
			// javascriptClick.click(selectTemplate);
			applyWait.waitForElementToBeClickable(selectRuleSearch, DefineConstants.explicitWait_30).click();
			selectRuleSearch.sendKeys(input_SelectRule);
			selectRuleSearch.sendKeys(Keys.ENTER);
			Screenshots.takeScreenshot(driver, input_SelectRule + " is selected as select rule");
			test.log(Status.INFO, input_SelectRule + " is selected as select rule");
			Log.info(input_SelectRule + " is selected as select rule");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
