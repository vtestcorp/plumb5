...
public class Web_Template {
	...
	public Web_Template(WebDriver driver, ExtentTest test) {
		this.driver = driver;
	...
	@FindBy(xpath = "//input[@id='txtRedirectUrl']")
	...
	public void click_UploadButton() {
		try {
			...
			Keyboard.pressTab();
			Keyboard.pressEnter();
			Screenshots.takeScreenshot(driver, "User clicked Upload Button");
			test.log(Status.INFO, "User clicked Upload Button");
			Log.info("User clicked Upload Button");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public void click_MessageButton() {
		try {
			applyWait.waitForElementToBeClickable(addMessage_SMSTemplate, DefineConstants.explicitWait_30);
			javascriptClick.click(addMessage_SMSTemplate);
			Screenshots.takeScreenshot(driver, "User clicked message button");
			test.log(Status.INFO, "User clicked message button");
			Log.info("User clicked message button");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void click_FileUploadButton() {
		try {
			applyWait.waitForElementToBeClickable(fileUploadButton, DefineConstants.explicitWait_30);
			javascriptClick.click(fileUploadButton);
			Screenshots.takeScreenshot(driver, "User clicked file upload button");
			test.log(Status.INFO, "User clicked file upload button");
			Log.info("User clicked file upload button");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void select_NotificationType(String input_NotificationType) {
		try {
			Thread.sleep(3000);
			notificationType = driver.findElement(By.xpath("//label[contains(text(),'"+input_NotificationType+"')]"));
			applyWait.waitForElementToBeClickable(notificationType, DefineConstants.explicitWait_30).click();
			Screenshots.takeScreenshot(driver, "User selected " + input_NotificationType + " as Notification Type");
			test.log(Status.INFO, "User selected " + input_NotificationType + " as Notification Type");
			Log.info("User selected " + input_NotificationType + " as Notification Type");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public void enter_OnClickAction(String input_PageUrl) {
		try {
			applyWait.waitForElementToBeClickable(pageUrl, DefineConstants.explicitWait_30).clear();
			pageUrl.sendKeys(input_PageUrl);
			Screenshots.takeScreenshot(driver, "User entered page url in Creatae SMS Template Page");
			test.log(Status.INFO, "User entered page url in Creatae SMS Template Page");
			Log.info("User entered page url in Creatae SMS Template Page");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
